...
COMPILER_BEST = 0.02777
COMPILER_WORST = 0.566

ASSERTIONS_BEST = 0.0078
ASSERTIONS_WORST = 0

CPPCHECK_BEST = 0.0012
CPPCHECK_WORST = 0.1029

CLANG_TIDY_BEST = 0.0116
CLANG_TIDY_WORST = 0.36

CYCLOMATIC_COMPLEXITY_BEST = 2.4
CYCLOMATIC_COMPLEXITY_WORST = 22.2

LIZARD_WARNINGS_BEST = 0.01326
LIZARD_WARNINGS_WORST = 0.3175

UNIQUE_BEST = 0.98
UNIQUE_WORST = 0.815

KWSTYLE_BEST = 0.0017
KWSTYLE_WORST = 0.05577
